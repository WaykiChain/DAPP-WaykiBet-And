...
public class MiddlewareWebViewClient extends MiddlewareWebClientBase {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
        Logger.i("Info", "MiddlewareWebViewClient -- >  shouldOverrideUrlLoading:" + request.getUrl().toString() + "  c:" + (count++));
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        Logger.i("Info", "MiddlewareWebViewClient -- >  shouldOverrideUrlLoading:" + url + "  c:" + (count++));
