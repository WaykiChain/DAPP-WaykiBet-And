...
import com.wayki.wallet.client.MiddlewareChromeClient;
import com.wayki.wallet.client.MiddlewareWebViewClient;
import com.wayki.wallet.dialog.LoadingDialog;
import com.wayki.wallet.ui.UIController;
import com.wayki.wallet.utils.JavaScriptInterface;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAgentWeb = AgentWeb.with(this)//
               ...
               // .setWebViewClient(mWebViewClient)//WebViewClient ， 与 WebView 使用一致 ，但是请勿获取WebView调用setWebViewClient(xx)方法了,会覆盖AgentWeb DefaultWebClient,同时相应的中间件也会失效。
                ...
                .setMainFrameErrorView(R.layout.web_error_page, -1) //参数1是错误显示的布局，参数2点击刷新控件ID -1表示点击整个布局都刷新， AgentWeb 3.0.0 加入。
...
//                .setNotifyIcon(R.drawable.ic_file_download_black_24dp) 4.0.0删除该api //下载通知图标。4.0.0后的版本请通过AgentWebDownloader#Extra修改icon
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("wayki", new JavaScriptInterface(getActivity()));
       ...
       AgentWebConfig.debug();
        ...
        //mAgentWeb.getWebCreator().getWebView().setBackgroundColor(0x01000000);
    }
    ...
    public String getUrl() {
        ...
        if (TextUtils.isEmpty(target = this.getArguments().getString(URL_KEY))) {
            target = "http://www.unkownwebsiteblog.me";
        }
    ...
    protected WebChromeClient mWebChromeClient = new WebChromeClient() {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            Logger.i(TAG, "onProgressChanged:" + newProgress + "  view:" + view);
        }
    ...
    protected WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(final WebView view, String url) {
            ...
            Logger.i("view:" + new Gson().toJson(view.getHitTestResult()));
            Logger.i("mWebViewClient shouldOverrideUrlLoading:" + url);
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            Logger.i("mUrl:" + url + " onPageStarted  target:" + getUrl());
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.iv_finish:
                    WebFragment.this.getActivity().finish();
                    //mAgentWeb.getJsAccessEntrace().quickCallJs("callJS","Hello ! WaykiChain");
                    // Toast.makeText(getActivity(), "调用JS方法", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
...
//            AgentWebConfig.clearDiskCache(this.getContext());
    ...
    public void refreshPage() {
        if (mAgentWeb != null) {
            mBridgeWebView.callHandler("notifyJSViewWillAppear","android call js",new CallBackFunction() {
                @Override
    ...
    class NetworkConnectChangedReceiver  extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(NetworkUtil.isConnected(context)){
                //Logger.e("网络连接");
              if(mAgentWeb!=null)  mAgentWeb.getUrlLoader().reload(); // 刷新
            }else{
                //Logger.e("网络断开");
                //networkStatus(false);
            }
